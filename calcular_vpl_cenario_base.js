// Script para calcular VPL da coluna SAVINGS no cenário base
const fetch = (...args) => import('node-fetch').then(({default: fetch}) => fetch(...args));

async function calcularVPLCenarioBase() {
    try {
        ...
        const response = await fetch('http://localhost:5000/api/dados/2');
